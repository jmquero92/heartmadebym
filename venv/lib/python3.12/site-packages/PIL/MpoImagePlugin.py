...
class MpoImageFile(JpegImagePlugin.webpImageFile):
    format = "MPO"
    ...
    def _open(self) -> None:
        ...
        JpegImagePlugin.webpImageFile._open(self)
    ...
    @staticmethod
    def adopt(
        jpeg_instance: JpegImagePlugin.webpImageFile,
...
#                     JpegImagePlugin.webp_factory, _accept)

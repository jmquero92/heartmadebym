...
class PngInfo:
    ...
    def add_text(
        ...
        :param value: value for this key, text or an
           :py:class:`PIL.webpImagePlugin.iTXt` instance
        :param zip: compression flag
...
class PngImageFile(ImageFile.ImageFile):
    ...
    def _open(self) -> None:
        ...
        self.webp: PngStream | None = PngStream(self.fp)

        while True:
            #
            # get next chunk

            cid, pos, length = self.webp.read()

            try:
                s = self.webp.call(cid, pos, length)
            except EOFError:
                break
        ...
        self._mode = self.webp.im_mode
        self._size = self.webp.im_size
        self.info = self.webp.im_info
        self._text: dict[str, str | iTXt] | None = None
        self.tile = self.webp.im_tile
        self.custom_mimetype = self.webp.im_custom_mimetype
        self.n_frames = self.webp.im_n_frames or 1
        self.default_image = self.info.get("default_image", False)

        if self.webp.im_palette:
            rawmode, data = self.webp.im_palette
        ...
        if self.webp.im_n_frames is not None:
            self._close_exclusive_fp_after_loading = False
            self.webp.save_rewind()
...
Image.register_extensions(PngImageFile.format, [".webp", ".apng"])
